...
export default function Home() {
  ...
  return (
    <div>
      ...
      <section id="Home"
        ref={homeRef}
        className="h-screen pt-20 group">
        <div className={`${container} h-full grid max-md:grid-rows-2 md:grid-cols-2 gap-1`}>
          <div className="grid grid-rows-[2fr_1fr] gap-1">
            <div className="flex items-end">
              {/* scale-0 group-target:scale-100 transition duration-150 ease-in-out */}
              <div className="">
                <h2 className={`transition-all duration-1000 transform ${homeInvisible ? '-translate-x-0 opacity-100' : '-translate-x-20 opacity-0'} text-4xl md:text-5xl font-bold text-primary`}>Hello,</h2>
                <h1 className={`transition-all duration-1050 transform ${homeInvisible ? '-translate-x-0 opacity-100' : '-translate-x-20 opacity-0'} text-5xl md:text-6xl font-extrabold`} >I Am Andre Bebon</h1>
                <p className={`transition-all duration-1200 transform ${homeInvisible ? '-translate-x-0 opacity-100' : '-translate-x-20 opacity-0'} font-medium`}><span className="text-primary font-bold">Backend Developer </span> || Frontend Developer ||
                  UI UX Designer || Experience working with Microsoft</p>
              </div>
            </div>
            <div className="flex flex-col justify-center max-md:items-center gap-1">
              {/* MD TO LG */}
              <div className={`flex gap-3.5 max-md:hidden`}>
                <div className={`transition-all duration-1300 transform ${homeInvisible ? '-translate-x-0 opacity-100' : '-translate-x-20 opacity-0'}`}>
          ...
          <div className={`master flex items-center justify-center max-md:hidden transition-all duration-1800 transform ${homeInvisible ? 'translate-x-0 opacity-100' : 'translate-x-20 opacity-0'}`} >
            <Image
          ...
          <div className={`flex items-center justify-center md:hidden transition-all duration-1800 transform ${homeInvisible ? '-translate-x-0 opacity-100' : '-translate-x-20 opacity-0'}`}>
            <Image
              src={"/images/1-Photoroom.png"}
              alt=""
              height={470}
        ...
        <section className="bg-secondary">
          <div className={`${container} py-20 md:py-40`}>
            <div data-aos="fade-up" data-aos-duration="1000">
              <h1 className={`text-3xl md:text-4xl font-bold italic text-center uppercase`}>About</h1>
            </div>
            <div className="py-5" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
              <p className={`text-center font-semibold italic text-primary`}>&quot; Setiap baris kode adalah langkah kecil menuju solusi besar.&quot;</p>
            </div>
            <div className="py-5 md:px-40" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
              <p className={`text-justify md:text-center font-semibold leading-loose`}>Saya Andreas Aryanto Bebon, mahasiswa akhir di Universitas Amikom Yogyakarta.
                Fokus saya di backend development (Laravel), namun kini saya mendalami Next.js untuk memperkuat kemampuan frontend.
                Terbiasa bekerja dalam tim, tepat waktu, dan memiliki pengalaman desain UI/UX menggunakan Figma & Adobe XD.</p>
            </div>
          </div>
        </section>
        {/* End ABOUT ME */}
      ...
      <section id="Skill"
        ...
        <div className={`${container} py-10 md:py-20 md:mb-32`}>
          <h1 className={`text-3xl md:text-4xl font-bold italic text-center uppercase`} data-aos="fade-up" data-aos-duration="500">Skill</h1>
        ...
        {/* DESCRIPTION MD >+ */}
        <div
          className="absolute w-full top-full xl:top-[600px] max-md:hidden">
              ...
              <div className="col-start-2 col-span-6">
                <div className={`grid grid-cols-3 lg:gap-10 md:gap-5`}>
                  ...
                  <div className="MDdeskripsi flex flex-col justify-center items-center bg-description rounded xl:py-10 py-2 xl:px-5 px-2 max-md:hover:scale-110 max-md:hover:bg-primary transition-all duration-300 ease-in-out">
                    ...
                    <div className="mb-2">
                      <p className="text-center font-semibold">Selama 3 tahun Design UI/UX untuk tugas kuliah membuat saya memiliki wawasan yang cukup luas tentang UI/UX Design</p>
                    </div>
                  </div>
                  ...
                  <div className="MDdeskripsi flex flex-col justify-center items-center bg-description rounded xl:py-10 py-2 xl:px-5 px-2 max-md:hover:scale-110 max-md:hover:bg-primary transition duration-300 xl:scale-110">
                    ...
                    <div className="mb-2">
                      <h1 className="text-2xl font-extrabold">Front End Development</h1>
                    </div>
                    <div className="mb-2">
                      <p className="text-center font-semibold">Selama 3 tahun membuat tampilan website untuk tugas kuliah dan projek membuat wawasan saya cukup luas tentang Front End.</p>
                    </div>
                  </div>
                  ...
                  <div className="MDdeskripsi flex flex-col justify-center items-center bg-description rounded xl:py-10 py-2 xl:px-5 px-2 max-md:hover:scale-110 max-md:hover:bg-primary transition duration-300">
                    ...
                    <div className="mb-2">
                      <p className="text-center font-semibold">Selama 3 tahun berfokus pada backend membuat logika dan wawasan saya berkembang mengenai Backend.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className={`${container}`}>
            <div className="bg-secondary flex justify-center py-2 px-2 ">
              <div className="-mt-8 flex flex-col gap-5 mb-5 ">
                <div className={`SMdeskripsi bg-description rounded-md drop-shadow-2xl py-2 px-3 flex flex-col items-center`}>
                  <div className="mb-2">
                    <Image
                      src={"/SVG/Design.svg"}
                      alt="design"
      ...
      {/* CERTIFICATE */}
      <section
        id="Certificate" className="md:bg-secondary">
        <div className={`${container} py-10 md:pt-56 xl:pt-28`}>
          <div className="sertifikat xl:mt-60 md:mt-40">
            <h1 className={`text-3xl md:text-4xl font-bold italic text-center uppercase`}>CERTIFICATE</h1>
          </div>
          <div className={`container flex flex-col items-center py-5 gap-y-10`}>
            ...
            {/* BUTTON TO LINKIN */}
            <div className={`sertifikat container flex flex-col items-center py-5 gap-y-10`}>
              <a href="#" className="flex gap-2 group">
                ...
                />
                <span className="text-sm md:text-xl font-semibold italic group-hover:text-primary">More In LinkedIn</span>
              </a>
            </div>
      ...
      {/* PORTOFOLIO */}
      <section
        id="Portofolio" className="md:bg-transparent bg-secondary">
        <div className={`${container} py-20 md:py-32 xl:py-40`}>
          <div className="">
            <h1 className={`text-3xl md:text-4xl font-bold italic text-center`} data-aos="fade-up" data-aos-duration="1000" >Galeri Portofolio</h1>
            <div className="grid grid-cols-1 gap-7 md:grid-cols-2 md:gap-8 py-5 mt-5">
              ...
              <div className={`flex justify-center items-center overflow-hidden rounded-md`} data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
                <Image
                  src={"/images/ss.png"}
                  alt="Shoes Store"
                  height={2800}
